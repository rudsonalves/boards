...
// soucer: https://github.com/jonataslaw/readmore/blob/master/lib/readmore.dart
// MIT Licensed
  ...
  RegExp? _mergeRegexPatterns(List<Annotation>? annotations) {
    ...
    return RegExp(
      annotations
          .map(
            (e) =>
                '(${e.regExp.pattern.replaceAll(_nonCapturingGroupPattern, '(?:')})',
          )
          .join('|'),
    );
  }
