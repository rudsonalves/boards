...
//   @override
//   Future<FavoriteModel?> add(FavoriteModel fav) async {
//     try {
//       final parseFav = ParseObject(keyFavoriteTable);
//       final parseAd = ParseObject(keyAdTable)..objectId = fav.adId;

//       parseFav
//         ..setNonNull(keyFavoriteOwner, fav.userId)
...
//   @override
//   Future<(List<AdModel>, List<FavoriteModel>)> getFavAds(String userId) async {
//     try {
//       final parseFav = ParseObject(keyFavoriteTable);
...
//   @override
//   Future<(List<AdModel>, List<FavoriteModel>)> getAll(String userId) {
